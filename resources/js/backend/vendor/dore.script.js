...
if ($().DataTable) {
    ...
    $.showAlert = function showAlert(type, title, message, url){
    ...
    $("body").on("click", ".notify-btn", function (event) {
      event.preventDefault();
      showNotification($(this).data("from"), $(this).data("align"), $(this).data("type"), $(this).data("title"), $(this).data("message"));
    });
